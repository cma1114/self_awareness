...
def main():
    ...
    file_list = ["capabilities_test_logs/gemini-2.5-flash_nothink_GPSA_447_1758122776_test_data.json", "capabilities_test_logs/gemini-2.5-flash_nothink_SimpleQA_500_1758122535_test_data.json"]
